...
<div className="home_section1 flex mt-4 overflow-hidden bg-[#e6e6fa]">
  ...
  <div className="border p-4 rounded fade-in">
    ...
    <div className="mb-2 text-xl font-extrabold">Society of Women Engineers</div>
    <div className="mb-2 text-base font-medium">Apply for a scholarship with a significant piece of work in one of five 
    subject categories to earn up to a $50,000 scholarship.Open to All High Schoolers. </div>
  ...
  <div className="border p-4 rounded fade-in">
    ...
    <div className="mb-2 text-xl font-extrabold">United Negro College Fund (UNCF)</div>
    <div className="mb-2 text-base font-medium">The United Negro College Fund (UNCF) scholarships are available to minority students throughout the United States. 
     A number of scholarship programs are offered through UNCF.</div>
  ...
  <div className="border p-4 rounded fade-in">
    ...
    <div className="mb-2 text-xl font-extrabold">BigFuture Scholarships</div>
    <div className="mb-2 text-base font-medium">BigFuture rewards students who take steps to plan for life after high school.
Sophomores and juniors can now qualify for $500 & $40k drawings this month by starting their career
 list or building their college list.</div>
  ...
  <div className="border p-4 rounded fade-in">
    ...
    <div className="mb-2 text-base font-medium">Explore a variety of scholarships and prizes on Scholarship America. In 2020, they served over 
    100,000 students and distributed over $273 million.
Open to All High Schoolers.</div>
