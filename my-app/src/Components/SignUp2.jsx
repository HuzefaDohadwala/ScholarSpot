...
const SignUp2 = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost:8000/signup", combinedData);
    ...
    <div>
      ...
      <Row className="mb-3">
                ...
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} md="4" controlId="validationCustomCurrentAcademicLevel">
  ...
  {/* <Form.Group as={Col} md="4" controlId="validationCustomGPA">
    <Form.Label>GPA</Form.Label>
    <Form.Control type="number" placeholder="GPA" value={GPA} onChange={(e) => setGPA(e.target.value)} required /> */}
  {/* </Form.Group> */}
  {/* <Form.Group as={Col} md="4" controlId="validationCustomFieldOfStudy">
    <Form.Label>Field of Study</Form.Label>
    <Form.Control type="text" placeholder="Field of Study" value={fieldOfStudy} onChange={(e) => setFieldOfStudy(e.target.value)} required />
  </Form.Group> */}
</Row>
...
<Row className="mb-3">
  <Form.Group as={Col} md="4" controlId="validationCustomCountry">
    ...
    <Form.Control as="select" required value={selectedCountry} onChange={(e) => setSelectedCountry(e.target.value)}>
  ...
  <Form.Group as={Col} md="4" controlId="validationCustomPercentage">
    ...
    <Form.Control type="text" placeholder="Percentage" required value={percentage} onChange={(e) => setPercentage(e.target.value)} />
  </Form.Group>
</Row>
...
<Form.Group as={Col} md="4" controlId="validationCustomQualification">
    ...
    <Form.Control as="select" required value={qualification} onChange={(e) => setQualification(e.target.value)}>
...
<Form.Group as={Col} md="4" controlId="validationCustomMajor">
    ...
    <Form.Control as="select" required value={major} onChange={(e) => setMajor(e.target.value)}>
...
<Form.Group as={Col} md="4" controlId="validationCustomCurrentAcademicLevel">
    <Form.Label>Current Academic Level</Form.Label>
    <Form.Control as="select" required value={currentAcademicLevel} onChange={(e) => setCurrentAcademicLevel(e.target.value)}>
...
{/* ... continue the pattern for remaining fields. */}
    ...
    <Form.Group as={Col} md="4" controlId="validationCustomSAT">
        ...
        <Form.Control
            ...
            onChange={(e) => setTestScores({ ...testScores, SAT: e.target.value })}
            required
        />
        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
    </Form.Group>
    ...
    <Form.Group as={Col} md="4" controlId="validationCustomACT">
        ...
        <Form.Control
            ...
            onChange={(e) => setTestScores({ ...testScores, ACT: e.target.value })}
            required
        />
        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
    </Form.Group>
    ...
    <Form.Group as={Col} md="4" controlId="validationCustomGRE">
        ...
        <Form.Control
            ...
            onChange={(e) => setTestScores({ ...testScores, GRE: e.target.value })}
            required
        />
        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
    </Form.Group>
...
<Form.Group as={Col} md="4" controlId="validationCustomEthnicity">
  ...
  <Form.Control as="select" value={ethnicity} onChange={(e) => setEthnicity(e.target.value)} required>
...
<Form.Group as={Col} md="4" controlId="validationCustomNationality">
  ...
  <Form.Control as="select" value={nationality} onChange={(e) => setNationality(e.target.value)} required>
...
<Row className="mb-3">
<Form.Group as={Col} md="4" controlId="validationCustomCurrentLocation">
  <Form.Label>Current Location</Form.Label>
  <Form.Control as="select" value={currentLocation} onChange={(e) => setCurrentLocation(e.target.value)} required>
...
<Form.Group as={Col} md="4" controlId="validationCustomPreferredStudyLocation">
  <Form.Label>Preferred Study Location</Form.Label>
  <Form.Control as="select" value={preferredStudyLocation} onChange={(e) => setPreferredStudyLocation(e.target.value)} required>
  ...
  <Form.Group as={Col} md="4" controlId="validationCustomExtraCurricularActivities">
...
<Row className="mb-3">
  <Form.Group as={Col} md="4" controlId="validationCustomPersonalInterests">
  ...
  <Form.Group as={Col} md="4" controlId="validationCustomMilitaryService">
